...
import static ru.gkomega.api.openparser.commons.enumeration.ErrorTemplateType.SERVICE_OPERATION_ERROR;
...
public class ServiceOperationException extends RuntimeException {
    ...
    public static ServiceOperationException throwInvalidOperation(@Nullable final Object... args) {
        throw throwInvalidOperationWith(SERVICE_OPERATION_ERROR.getCode(), args);
    }
